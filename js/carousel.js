...
function changePlace() {
  for (let step = 0; step < 3; step++) {
    ...
    document.documentElement.style.setProperty(`--src${positions[step]}`, `linear-gradient(rgba(29, 38, 113, ${opac}), rgba(195, 55, 100, ${opac})), url('/images/${myMap.get(positions[step])}.jpg')`);
  }
} 
